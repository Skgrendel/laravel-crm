...
return [
    ...
    'settings' => [
        'index' => [
            ...
            'logout-btn' => 'Desconectar',
            'logout-confirm' => 'Esto desvincula el número actual de WhatsApp ahora mismo y te va a mostrar un QR nuevo para conectar otro número. La conversación con los clientes actuales no se borra, pero dejan de llegar mensajes nuevos hasta que vincules un número de nuevo. ¿Confirmás?',
            'logout-success' => 'Número desconectado, generando QR nuevo.',
