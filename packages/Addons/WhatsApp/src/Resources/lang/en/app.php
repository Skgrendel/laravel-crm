...
return [
    ...
    'settings' => [
        'index' => [
            ...
            'logout-btn' => 'Disconnect',
            'logout-confirm' => 'This unlinks the current WhatsApp number right now and shows a new QR to connect a different one. Existing conversations aren\'t deleted, but no new messages arrive until a number is linked again. Confirm?',
            'logout-success' => 'Number disconnected, generating a new QR.',
